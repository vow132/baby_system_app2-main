      ...
      <view class="response-grid">
        <view class="response-item">
          <view class="response-icon light">
            <u-icon name="bulb-fill" size="20" color="#fff" />
          </view>
        ...
        <view class="popup-actions">
          <view class="popup-action">
            <view class="pa-icon light">
              <u-icon name="bulb-fill" size="16" color="#fff" />
            </view>
...
const fallbackScenes: SceneItem[] = [
  { key: "sleep", category: "sleep", name: "熟睡", icon: "moon-fill", levelKey: "silent", levelText: "静默", status: "安静睡眠中", trigger: "呼吸稳定，位移小，环境低噪声", notice: "次日报告", actions: { light: "低亮", sound: "安静", app: "日报" }, vitals: { heart: "102", breath: "平稳", confidence: "93%" } },
  { key: "wake", category: "wake", name: "苏醒", icon: "sun-fill", levelKey: "normal", levelText: "建议", status: "宝宝醒啦", trigger: "睁眼，伸展，轻微哼声", notice: "轻提醒", actions: { light: "晨光", sound: "问候", app: "EASY" }, vitals: { heart: "112", breath: "正常", confidence: "89%" } },
